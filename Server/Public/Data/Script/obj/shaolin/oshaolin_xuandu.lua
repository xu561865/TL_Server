...
--所拥有的事件ID列表
x009004_g_eventList={estudy_kaiguang,elevelup_kaiguang}	
...
function x009004_UpdateEventList( sceneId, selfId,targetId )
	...
	AddNumText(sceneId,g_scriptId,"购买开光配方",-1,5)
...
function x009004_OnEventRequest( sceneId, selfId, targetId, eventId )
	if	GetNumText()==5	then
		DispatchShopItem( sceneId, selfId,targetId, x009004_g_shoptableindex )
	end
