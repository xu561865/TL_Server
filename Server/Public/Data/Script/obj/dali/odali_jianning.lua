...
function x002039_UpdateEventList( sceneId, selfId,targetId )
	...
	if Menpai == OR_WUMENPAI then
		AddText(sceneId,"  在下简宁，乃丐帮长老。#r#r  如今丐帮可不仅仅是我这样的老叫花子，而是广纳有志之士，日后必成天下第一大帮，你有兴趣加入吗？#r#r  丐帮武功以后劲见长，愈战愈勇。")
	elseif Menpai == OR_GAIBANG then
	...
	if	GetLevel( sceneId, selfId)<=10	then
		AddNumText(sceneId,x002039_g_scriptId,"去丐帮看看",-1,0)
	end
