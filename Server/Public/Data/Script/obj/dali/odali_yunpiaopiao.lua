...
x002051_g_shoptableindex=7

--所拥有的事件ID列表
x002051_g_eventList={210214,210215,210216,210220,210221,210223,210218}
...
function x002051_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
	AddText(sceneId,"我这里的鸟虫鱼物，可都是稀世珍品，告诉你个秘密，我还有从西夏国带回来的小宝贝呢。")
	AddNumText(sceneId,x002051_g_scriptId,"购买宠物用品",-1,0)
