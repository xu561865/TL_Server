...
function x002045_UpdateEventList( sceneId, selfId,targetId )
	...
	if Menpai == OR_WUMENPAI then
		AddText(sceneId,"  在下青霜，天山灵鹫宫接引使。#r#r  天山号令，行之五湖，你不见三十六岛七十二洞唯灵鹫宫马首是瞻吗？#r#r  天山武功至奇至绝，可隐没身形，可幻化身形，杀人于无声。")
	elseif Menpai == OR_TIANSHAN then
	...
	if	GetLevel( sceneId, selfId)<=10	then
		AddNumText(sceneId,x002045_g_scriptId,"去灵鹫宫看看",-1,0)
	end
