...
function x334805_OnConditionCheck( sceneId, selfId )
	...
	if(-1~=x334805_g_MenPai) then
		if(LuaFnGetMenPai(sceneId, selfId)==x334805_g_MenPai) then --门派专用座骑检查
			return 1;
		else
...
function x334805_OnActivateOnce( sceneId, selfId )
	...
	Msg2Player( sceneId,selfId,"您已经骑上青凤了。",MSG2PLAYER_PARA) --通知玩家
	return 1;
end
