...
function x026007_UpdateEventList( sceneId, selfId,targetId )
	...
	local IsDone605 = IsMissionHaveDone(sceneId,selfId,605)
	
	--print(IsHaveMission(sceneId,selfId,605), IsDone605 ~= 0)	
		
	
	if(IsDone605 == 0) then		
		AddText(sceneId, "把我的剑交给我的妻子郑萼吧")	
	end
