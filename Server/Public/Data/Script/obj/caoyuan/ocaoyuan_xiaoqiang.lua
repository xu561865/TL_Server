...
--所拥有的事件ID列表
x020003_g_eventList={211102,211103,211104,211105,211107,211106,211107,211108}	
...
function x020003_UpdateEventList( sceneId, selfId,targetId )
	...
	if IsStepDone4 == 1 then
		AddText(sceneId,"  "..PlayerName.."，我真的非常感激你。#r如果你在辽国境内遇到什么问题，都可以来找我帮忙。#r  对了，你也要记得不要把我的事情告诉任何人哦。#r")
	--没有完成“郡主的命令”、“马匪首领”、“英雄的证明”任务之前
	elseif IsStepDone1 == 0 and IsStepDone2 == 0 and IsStepDone3 == 0 then
		AddText(sceneId,"  你就是"..PlayerName.." ？#r  哥哥从雁北来信说你英雄了得，让我好好招待。我看你也不是很像个英雄嘛。#r")
	--完成“灵魂的呼唤”任务之前
	else
		AddText(sceneId,"  我可不是别人说什么我就信什么的人哦，你如果真的是英雄，我自然会好好的款待你。#r")
	end
