...
function x000082_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddNumText(sceneId,x000082_g_scriptId,"苏州",-1,0)
		AddNumText(sceneId,x000082_g_scriptId,"大理",-1,1)
		AddNumText(sceneId,x000082_g_scriptId,"少林寺",-1,2)
		AddNumText(sceneId,x000082_g_scriptId,"明教",-1,3)
		AddNumText(sceneId,x000082_g_scriptId,"丐帮",-1,4)
		AddNumText(sceneId,x000082_g_scriptId,"武当山",-1,5)
		AddNumText(sceneId,x000082_g_scriptId,"峨嵋山",-1,6)
		AddNumText(sceneId,x000082_g_scriptId,"星宿海",-1,7)
		AddNumText(sceneId,x000082_g_scriptId,"天龙寺",-1,8)
		AddNumText(sceneId,x000082_g_scriptId,"天山",-1,9)
		AddNumText(sceneId,x000082_g_scriptId,"逍遥派",-1,10)
	EndEvent(sceneId)
