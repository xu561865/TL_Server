...
--任务文本描述
x210227_g_MissionName="新手：人之初"
x210227_g_MissionInfo="不过只给那小乞丐一个馒头也救不了他，早晚会冻死的，你再去给他件粗布衣吧。"
x210227_g_MissionTarget="到黄公道[238,171]处给小乞丐[202,256]买一件粗布衣"
x210227_g_ContinueInfo="给他了吗？"
x210227_g_MissionComplete="不错，这是给你的奖励。"
x210227_g_SignPost = {x = 202, z = 256, tip = "小乞丐"}
--任务奖励
x210227_g_MoneyBonus=500
...
function x210227_OnAccept( sceneId, selfId )
	...
	CallScriptFunction( SCENE_SCRIPT_ID, "AskTheWay", sceneId, selfId, SCENE_DALI, x210227_g_SignPost.x, x210227_g_SignPost.z, x210227_g_SignPost.tip )
end
...
function x210227_OnSubmit( sceneId, selfId, targetId,selectRadioId )
	if x210227_CheckSubmit( sceneId, selfId, selectRadioId ) then
