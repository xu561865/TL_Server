...
--任务文本描述
x210235_g_MissionName="御赐精纺护腕"
x210235_g_MissionInfo="大理皇宫本来要做很多的宫廷八宝粥，作为武林大会的美食的。但无量山的闪电豹首领偷走了一品银耳，剑阁的白茅草人首领偷走了一品芋头，如果你能够把它们找回来，我就送你一件御赐的精纺护腕"  --任务描述
x210235_g_MissionTarget="找到一品银耳和一品芋头"		--任务目标
x210235_g_ContinueInfo="一品银耳和一品芋头"		--未完成任务的npc对话
		...
		if ret > 0 then
			...
			if	ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#Y完成任务：御赐精纺护腕",MSG2PLAYER_PARA )
				end
			else
				--删除物品不成功
				BeginEvent(sceneId)
