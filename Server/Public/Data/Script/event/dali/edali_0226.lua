...
--任务文本描述
x210226_g_MissionName="新手：人之初"
x210226_g_MissionInfo="那边有个小乞丐快要饿死了，你去给他个馒头，我就告诉你真相。"
x210226_g_MissionTarget="给小乞丐[202,256]馒头。"
x210226_g_ContinueInfo="给他了吗？"
x210226_g_MissionComplete="不错，这是给你的奖励。"
x210226_g_SignPost = {x = 202, z = 256, tip = "小乞丐"}
--任务奖励
x210226_g_MoneyBonus=500
...
function x210226_OnAccept( sceneId, selfId )
	...
	CallScriptFunction( SCENE_SCRIPT_ID, "AskTheWay", sceneId, selfId, SCENE_DALI, x210226_g_SignPost.x, x210226_g_SignPost.z, x210226_g_SignPost.tip )
end
...
function x210226_OnSubmit( sceneId, selfId, targetId,selectRadioId )
	if x210226_CheckSubmit( sceneId, selfId, selectRadioId ) then
