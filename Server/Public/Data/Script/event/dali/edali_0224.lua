...
--任务文本描述
x210224_g_MissionName="新手：人之初"
x210224_g_MissionInfo="你先去看看大理城的告示再回来找我。"
x210224_g_MissionTarget="阅读公告牌[148,40]"
x210224_g_ContinueInfo="看明白了吗？"
x210224_g_MissionComplete="回来了就好。"
x210224_g_SignPost = {x = 148, z = 40, tip = "公告牌"}
--任务奖励
x210224_g_MoneyBonus=500
...
function x210224_OnAccept( sceneId, selfId )
	...
	CallScriptFunction( SCENE_SCRIPT_ID, "AskTheWay", sceneId, selfId, SCENE_DALI, x210224_g_SignPost.x, x210224_g_SignPost.z, x210224_g_SignPost.tip )
end
...
function x210224_OnSubmit( sceneId, selfId, targetId,selectRadioId )
	if x210224_CheckSubmit( sceneId, selfId, selectRadioId ) then
