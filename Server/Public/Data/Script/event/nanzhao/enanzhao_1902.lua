...
--任务是否已经完成
x211902_g_IsMissionOkFail = 0		--变量的第0位

--任务需要杀死的怪
x211902_g_DemandKill ={{id=1985,num=10}}		--变量第1位

--以上是动态**************************************************************

--任务文本描述
x211902_g_MissionName="沼泽鳄鱼"
x211902_g_MissionInfo="杀死10只沼泽鳄鱼"  --任务描述
x211902_g_MissionTarget="杀死10只沼泽鳄鱼"		--任务目标
x211902_g_ContinueInfo="你已经杀了10只沼泽鳄鱼吗？"		--未完成任务的npc对话
x211902_g_MissionComplete="太谢谢你了"					--完成任务npc说话的话
...
--任务入口函数
--**********************************
function x211902_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x211902_OnAccept( sceneId, selfId )
	--加入任务到玩家列表
	AddMission( sceneId,selfId, x211902_g_MissionId, x211902_g_ScriptId, 1, 0, 0 )		--添加任务
	misIndex = GetMissionIndexByID(sceneId,selfId,x211902_g_MissionId)			--得到任务的序列号
