...
--任务是否已经完成
x211302_g_IsMissionOkFail = 0		--变量的第0位

--以上是动态**************************************************************

--任务需要得到的物品
x211302_g_DemandItem={{id=40002103,num=1}}		--变量第1位

--任务文本描述
x211302_g_MissionName="药酒"
x211302_g_MissionInfo="帮我把这碗调好的药酒带给吴乞买"
x211302_g_MissionTarget="将调好的药酒带给吴乞买"
x211302_g_ContinueInfo="这是给你的药酒"
x211302_g_MissionComplete="谢谢"
...
function x211302_OnAccept( sceneId, selfId )
	...
	if ret > 0 then 
		...
		if ret > 0 then
			...
			misIndex = GetMissionIndexByID(sceneId,selfId,x211302_g_MissionId)			--得到任务的序列号
