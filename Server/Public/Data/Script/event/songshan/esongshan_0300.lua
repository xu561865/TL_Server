...
x210300_g_IsMissionOkFail = 0		--变量的第0位
...
x210300_g_MissionName="白额虎"

x210300_g_MissionTarget="杀死10个白额虎"		--任务目标
x210300_g_MissionInfo="求求你，去帮我杀10个白额虎"

x210300_g_ContinueInfo="真笨啊，快点去！"		--未完成任务的npc对话

x210300_g_MissionComplete="嗯？看来你有两下子嘛。"					--完成任务npc说话的话
...
--任务需要杀死的怪
x210300_g_DemandTrueKill = {{name="白额虎",num=10}};		--变量第1位
...
function x210300_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x210300_OnAccept( sceneId, selfId )
	...
	AddMission( sceneId, selfId, x210300_g_MissionId, x210300_g_ScriptId, 1, 0, 0 );		--添加任务

	misIndex = GetMissionIndexByID(sceneId, selfId, x210300_g_MissionId);			--得到任务的序列号
	  ...
	  if num < x210300_g_DemandTrueKill[1].num then
	    ...
	    SetMissionByIndex(sceneId,selfId,misIndex,1,num+1)
	  	...
	  	BeginEvent(sceneId)
			...
			strText = format("已杀死白额虎%d/10", GetMissionParam(sceneId,selfId,misIndex,1) )
