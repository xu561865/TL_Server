...
--任务需要得到的物品
x212109_g_DemandItem={{id=40002078,num=1}}		--变量第1位

--任务文本描述
x212109_g_MissionName="生死兄弟"
x212109_g_MissionInfo="把这封信交给张龙"
x212109_g_MissionTarget="任务目标：#r把这封信交给张龙"
x212109_g_ContinueInfo="这是马汉让我给你的"
x212109_g_MissionComplete="谢谢你"
...
function x212109_OnAccept( sceneId, selfId )
	...
	if ret > 0 then 
		...
		if ret > 0 then
			...
			misIndex = GetMissionIndexByID(sceneId,selfId,x212109_g_MissionId)			--得到任务的序列号
