...
--任务是否已经完成
x211006_g_IsMissionOkFail = 0		--变量的第0位

--任务需要杀死的怪
x211006_g_DemandKill ={{id=1695,num=10}}		--变量第1位

--以上是动态**************************************************************

--任务文本描述
x211006_g_MissionName="混乱的亲兵"
x211006_g_MissionInfo="干掉10个秦家寨亲兵"
x211006_g_MissionTarget="干掉10个秦家寨亲兵"
x211006_g_ContinueInfo="你已经杀了10个秦家寨亲兵了吗？"
x211006_g_MissionComplete="恭喜你杀完了"
...
function x211006_OnAccept( sceneId, selfId )
	--加入任务到玩家列表
	AddMission( sceneId,selfId, x211006_g_MissionId, x211006_g_ScriptId, 1, 0, 0 )		--添加任务
	misIndex = GetMissionIndexByID(sceneId,selfId,x211006_g_MissionId)			--得到任务的序列号
