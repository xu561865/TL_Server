...
--任务是否已经完成
x211004_g_IsMissionOkFail = 0		--变量的第0位

--以上是动态**************************************************************

--任务需要得到的物品
x211004_g_DemandItem={{id=40002062,num=1}}		--变量第1位

--任务文本描述
x211004_g_MissionName="神秘的来信"
x211004_g_MissionInfo="这里发现一个奇怪的皮袋子，请你把它交给曲端将军"
x211004_g_MissionTarget="把皮袋子交给曲端"
x211004_g_ContinueInfo="你有什么事吗？"
x211004_g_MissionComplete="哦，收到"
...
function x211004_OnAccept( sceneId, selfId )
	...
	if ret > 0 then 
		...
		if ret > 0 then
			...
			misIndex = GetMissionIndexByID(sceneId,selfId,x211004_g_MissionId)			--得到任务的序列号
