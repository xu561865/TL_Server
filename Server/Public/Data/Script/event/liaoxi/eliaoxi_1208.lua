...
--任务是否已经完成
x211208_g_IsMissionOkFail = 0		--变量的第0位

--以上是动态**************************************************************

--任务需要得到的物品
x211208_g_DemandItem={{id=40002071,num=1}}		--变量第1位

--任务文本描述
x211208_g_MissionName="勇士的家书"
x211208_g_MissionInfo="这封信上已经沾满了血迹，只能隐隐约约的看出几个字：石林……李……母亲……"
x211208_g_MissionTarget="把沾满血迹的信交给石林的李老太太"
x211208_g_ContinueInfo="你有什么事吗？"
x211208_g_MissionComplete="哦，收到"
...
function x211208_OnAccept( sceneId, selfId )
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x211208_g_MissionId)			--得到任务的序列号
