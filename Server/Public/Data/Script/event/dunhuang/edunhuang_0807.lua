...
--任务是否已经完成
x210807_g_IsMissionOkFail = 0		--变量的第0位

--任务需要杀死的怪
x210807_g_DemandKill ={{id=1570,num=10}}		--变量第1位

--******以上是动态******

--任务文本描述
x210807_g_MissionName="莫高窟"
x210807_g_MissionInfo="杀死10个修罗探子！"
x210807_g_MissionTarget="杀死10个修罗探子"
x210807_g_ContinueInfo="你已经杀了10个修罗探子吗？"
x210807_g_MissionComplete="恭喜你杀完了"
...
--任务入口函数
--**********************************
function x210807_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x210807_OnAccept( sceneId, selfId )
	--加入任务到玩家列表
	AddMission( sceneId,selfId, x210807_g_MissionId, x210807_g_ScriptId, 1, 0, 0 )	--添加任务
	misIndex = GetMissionIndexByID(sceneId,selfId,x210807_g_MissionId)	--得到任务的序列号
