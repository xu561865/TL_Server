...
--任务入口函数
--**********************************
function x713602_OnDefaultEvent( sceneId, selfId, targetId, MessageNum )	--MessageNum是对话编号，用于调用不同对话
		BeginEvent(sceneId)
...
function x713602_OnEnumerate( sceneId, selfId, targetId )
		AddNumText(sceneId,x713602_g_ScriptId,"我想了解中医")
end
